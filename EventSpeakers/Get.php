...
<body>
<h1>Inregistrarile din tabela eventspeakers</h1>
<p><b>Toate inregistrarile din eventspeakers</b</p>
<?php
// connectare bazadedate
include("../ConnectDB.php");
// se preiau inregistrarile din baza de date
if ($result = $mysqli->query("SELECT * FROM eventspeakers ORDER BY ID "))
...
// antetul tabelului
        echo "<tr><th>ID</th><th>EventID</th><th>SpeakerID
