...
<body>
    ...
    <div class="main-content">
        <div class="container-path">
            <p><span class="container-path-pages">Pages /</span> Add speaker</p>
        </div>
                ...
                <div class="form-body">
                    ...
                    <form id="myForm" class="form" action="" method="POST">
                        <div class="label">
                            ...
                            <input type="text" name="Name" placeholder="Type speaker name" required>
                        </div>
                        <div class="label">
                            <label>Speaker details</label>
                            <input type="text" name="Details" placeholder="Type speaker details" required>
                        </div>
                    </form>
                </div>
        </div>
