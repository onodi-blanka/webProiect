            ...
            if (is_numeric($_POST['ID']))
            {
                ...
                else
                {
                    if ($stmt = $mysqli->prepare("UPDATE eventpartnerssponsors SET PartnerSponsorID = ? WHERE ID='" . $ID . "'"))
                    {
                        ...
                        $stmt->execute();
                        $stmt->close();
                        header("Location: event-sponsors.php?EventID=" . $_GET['EventID']);  
                    }
                    else
                    {
...
<head>
    ...
    <title>Event sponsor modify</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container-path">
            <p><span class="container-path-pages">Pages /</span> Modify event sponsor</p>
        </div>
                                            ...
                                            ?>
                                                <div class="event-information label">
                                                    <label>Sponsors</label>
                                                        <?php
                                                            include("../../../src/conectare.php");
                                                            include("../../../src/fetch-sponsors.php");
                                                        ?>
