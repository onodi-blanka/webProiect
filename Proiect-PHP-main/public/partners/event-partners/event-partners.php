                                            ...
                                            echo "<td>";
                                                    echo "<i class='fa-solid fa-ellipsis dropdown-button' onclick='toggleDropdown(this)'></i>";
                                                        echo "<div class='dropdown'>";
                                                            echo "<a href='event-partners-modify.php?ID=" . $row->ID . "&EventID=" . $_GET['EventID'] . "'>Modify</a>"; 
                                                            echo "<a href='event-partners-delete.php?ID=" . $row->ID . "&EventID=" . $_GET['EventID'] . "'>Delete</a>";
                                                        echo "</div>";
                                            echo "</td>";
                                        echo "</tr>";
                                    echo "</tbody>";
